...
cap.set(CAP_PROP_FRAME_HEIGHT, 480); #setting height of the video
...
with mp_hands.Hands(min_detection_confidence=0.5, min_tracking_confidence=0.5) as hands:
    ...
    while cap.isOpened():
        ...
        #invert the image as it is laterally inverted
         ...
         if (results.multi_hand_landmarks):
               x1,y1 = lmlist[8][1:] #coordinates of the tip of index fingers
               xf = np.interp(x1,(150,640),(0,wScr))
               yf = np.interp(y1,(150,480),(0,hScr))
